...
public class GoodDaoImpl implements IGoodDao {
	...
	public int add(Good good) {
		...
		String sql = "INSERT INTO goods (goodname,goodownerid,price,original_price,description,condition_status,function_status,purchase_time,trade_method,brand,model,specifications,tags,is_negotiable,image,num,time,isbn,chubanshe,author,chubantime,category_id,location,view_count,inquiry_count) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		try {
			...
			ps.setDouble(4, good.getOriginalPrice());
			ps.setString(5, good.getDescription());
			ps.setString(6, good.getConditionStatus());
			ps.setString(7, good.getFunctionStatus());
			ps.setString(8, good.getPurchaseTime());
			ps.setString(9, good.getTradeMethod());
			ps.setString(10, good.getBrand());
			ps.setString(11, good.getModel());
			ps.setString(12, good.getSpecifications());
			ps.setString(13, good.getTags());
			ps.setBoolean(14, good.isNegotiable());
			ps.setString(15, good.getImagesStr());
			ps.setInt(16, good.getNum());
			ps.setTimestamp(17, good.getTime());
			ps.setString(18, good.getIsbn());
			ps.setString(19, good.getChubanshe());
			ps.setString(20, good.getAuthor());
			ps.setString(21, good.getChubantime());
			ps.setInt(22, good.getCategoryId());
			ps.setString(23, good.getLocation());
			ps.setInt(24, 0); // 初始浏览量为0
			ps.setInt(25, 0); // 初始询问量为0
