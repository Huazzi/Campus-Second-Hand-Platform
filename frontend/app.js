App({
  ...
  globalData:{
    userInfo:{},
    APPID:"wx0ff276098bd13b71",  // 小程序的AppID
    APPSERCET:"e320bcae5db72c81b8af57c04dad7c2c", // 小程序的AppSecret
    host: "http://localhost:8080/base-api/",
    // baseUrl: "http://localhost:8000" // 推荐系统API的基础URL
    recommend_api: "http://localhost:8080/base-api", // 指向Java后端API
