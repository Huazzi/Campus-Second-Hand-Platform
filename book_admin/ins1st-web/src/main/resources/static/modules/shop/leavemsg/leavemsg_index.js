layui.use(['table', 'form'], function () {
    ...
    table.render({
        elem: '#tb'
        , url: Base.ctxPath + '/leavemsg/leaveMsg/queryList'
        , cols: [[
            {type: 'radio'},
                {field: 'id', title: 'ID'},
     ...
     */
    $("#add").click(function () {
        Base.open('添加', Base.ctxPath + '/leavemsg/leaveMsg/add', '480', '400',true);
    });
    ...
    $("#edit").click(function () {
        var data = Base.getSelected(table, 'tb');
                ...
                Base.open('修改', Base.ctxPath + '/leavemsg/leaveMsg/edit?id=' + data[0].id, '480', '400',true);
    });
    ...
    $("#del").click(function () {
        ...
        Base.confirm("是否删除该记录？", function () {
            $.ajax({
                url: Base.ctxPath + "/leavemsg/leaveMsg/del",
                type: "post",
                data: {
                    "id": data[0].id
                },
