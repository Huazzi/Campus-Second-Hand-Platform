package com.ins1st.modules.shop.message.entity;
...
public class Message extends Page {
	...
	public String toString() {
		return "Message{" + "id=" + id + ", senduserid=" + senduserid + ", reciveuserid=" + reciveuserid + ", goodid="
				+ goodid + ", status=" + status + ", content=" + content + ", time=" + time + ", title=" + title + "}";
	}
}
