...
import com.ins1st.modules.sys.log.entity.SysBizLog;
import com.ins1st.modules.sys.log.service.ISysBizLogService;
import com.ins1st.util.DateUtils;
...
public class ReqAspect {
    ...
    @Pointcut("@annotation(com.ins1st.annotation.Req4Model)||@annotation(com.ins1st.annotation.Req4Json)")
    private void cut() {
    }
