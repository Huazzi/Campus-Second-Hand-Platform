...
public class GoodDaoImpl implements IGoodDao {
	...
	public int add(Good good) {
		...
		String sql = "INSERT INTO goods (goodname,goodownerid,price,description,image,num,catagory,time,isbn,chubanshe,author,chubantime) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		try {
			...
			ps.setString(9, good.getIsbn());
			ps.setString(10, good.getChubanshe());
			ps.setString(11, good.getAuthor());
			ps.setString(12, good.getChubantime());
	...
	public List<Good> load(String goodname) {
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT userId) collect FROM goods WHERE goodname like ? and num > 0 GROUP BY id";
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public Good load(int id) {
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT userId) collect FROM goods WHERE id = ?";
		PreparedStatement ps = null;
		ResultSet rs = null;
		Good good = null;
		try {
	...
	public List<Good> loadByCatagory(String goodname, String catagory) {
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT userId) collect FROM goods WHERE goodname like ? and catagory like ? and num > 0 GROUP BY id";
		PreparedStatement ps = null;
		ResultSet rs = null;
		List<Good> goods = new ArrayList<Good>();
		try {
	 ...
	 * @return 教材列表
	 */
	public List<Good> loadWithCondition(String goodname, String catagory, double minPrice, double maxPrice, int start,
			int end) {
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT userId) collect FROM goods WHERE goodname like ? and catagory like ? and price > ? and price < ? and num > 0 GROUP BY id ORDER BY time DESC LIMIT ?,?";
		PreparedStatement ps = null;
		ResultSet rs = null;
		List<Good> goods = new ArrayList<Good>();
		try {
	...
	public List<Good> loadByUser(int userId) {
		...
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT userId) collect FROM goods WHERE goodownerid = ? AND num > 0 GROUP BY id";
		PreparedStatement ps = null;
		ResultSet rs = null;
		List<Good> goods = new ArrayList<Good>();
		try {
	...
	public List<Good> loadByCollectUser(int userId) {
		Connection connection = DBUtil.getConnection();
		String sql = "SELECT id,goodname,goodownerid,price,description,image,num,catagory,time, COUNT(DISTINCT lid) leave_msg,COUNT(DISTINCT collect.userId) collect FROM goods JOIN collect ON goods.id = collect.goodId WHERE collect.userId = ? AND num > 0 GROUP BY id";
		PreparedStatement ps = null;
		ResultSet rs = null;
		List<Good> goods = new ArrayList<Good>();
		try {
